...
ifeq (byt_t_crv2,$(wildcard vendor/intel/hardware/PRIVATE/widi/config/Android.mk)$(REF_PRODUCT_NAME))# test inexistance of original makefile, and correct ref product
