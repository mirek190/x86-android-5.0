...
typedef struct
{
    tbd_record_header_t header; /*!< Record header with Format ID: UInt8 (See AIQB_DataID), Name ID: CMC_Comment (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header; /*!< Record header with Format ID: Uint16 (See AIQB_DataID) Name ID: CMC_GeneralData. (enum CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;      /*!< Record header with Format ID: Custom (See AIQB_DataID) Name ID: CMC_BlackLevel. (enum CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header; /*!< Record header with Format ID: UInt16 (See AIQB_DataID) Name ID: CMC_SaturationLevel. (enum CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header; /*!< Record header with Format ID: Custom (See AIQB_DataID) Name ID: CMC_DynamicRangeAndLinearity. (enum CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header; /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_ModuleSensitivity (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header; /*!< Record header with Format ID: ??? (See AIQB_DataID), Name ID: CMC_DefectPixels (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header; /*!< Record header with Format ID: Float (See AIQB_DataID), Name ID: CMC_Noise (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;  /*!< Record header with Format ID: Custom (See AIQB_DataID), Name ID: CMC_LensShadingCorrection (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;       /*!< Record header with Format ID: Custom (See AIQB_DataID), Name ID: CMC_LensShadingCorrectionRatio (See CMC_NameID). */
    uint16_t num_grids;               /*!< Number of LSC grids. */
    uint16_t grid_width;              /*!< LSC Grid width. */
    uint16_t grid_height;             /*!< LSC Grid height. */
...
typedef struct
{
    tbd_record_header_t header; /*!< Record header with Format ID: Float (See AIQB_DataID), Name ID: CMC_GeometricDistortionCorrection (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;                          /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_OpticsAndMechanics (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;           /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_ModuleSpectralResponse (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;       /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_ChromaticityResponse (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;         /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_FlashChromaticity (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;          /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_ColorMatrices (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;       /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_NVMInfo (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;          /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_AnalogGainConversion (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;          /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_DigitalGain (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;          /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_GeometricDistortion2 (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;          /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_ExposureRange (See CMC_NameID). */
...
typedef struct
{
    tbd_record_header_t header;          /*!< Record header with Format ID: UInt16 (See AIQB_DataID), Name ID: CMC_MultiLEDFlashChromaticity (See CMC_NameID). */
