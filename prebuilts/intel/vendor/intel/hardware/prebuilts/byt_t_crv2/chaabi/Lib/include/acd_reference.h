...
/*
 * This header file has been provided as a reference to ACD (Android Customer
 * Data) indices. Any other relevant reference information can be added here.
 *
 * Original Author:
 *	Jayant Mangalampalli<jayant.mangalampalli@intel.com>
*/

#ifndef __ACD_REFERENCE_H_
#define __ACD_REFERENCE_H_

/* Android Customer Data field indices */
/* Android Customer Data field indices */
