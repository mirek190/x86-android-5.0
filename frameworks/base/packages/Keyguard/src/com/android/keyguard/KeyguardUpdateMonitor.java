...
import android.hardware.usb.UsbManager;  //jw
...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener {
    ...
    private static final int MSG_USB_STATE_CHANGE = 326; //jw
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_SIM_STATE_CHANGE:
                    ...
                    break;
		        case MSG_USB_STATE_CHANGE: //jw
		            handleUsbStateChanged();
		            break;
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_TIME_TICK.equals(action)
		    	...
		    	Log.d(TAG, "jw pin interface mSimState = " + mSimState);
	       		if((mSimState == IccCardConstants.State.PIN_REQUIRED) || (mSimState == IccCardConstants.State.PUK_REQUIRED)) { 
                   mHandler.sendMessage(mHandler.obtainMessage(MSG_USB_STATE_CHANGE,
    ...
    private KeyguardUpdateMonitor(Context context) {
		...
		filter.addAction(UsbManager.ACTION_USB_DEVICE_DETACHED); //jw
    ...
    private void handleUsbStateChanged() { //jw
	    if(DEBUG) {
		    Log.d(TAG, "handleUsbStateChanged: mSimState = " + mSimState + " phone state " + getPhoneState());
            }

            
            if ((IccCardConstants.State.PIN_REQUIRED == mSimState) 
				|| (IccCardConstants.State.PUK_REQUIRED == mSimState)) {
