...
final class WindowState implements WindowManagerPolicy.WindowState {
    ...
    WindowState(WindowManagerService service, Session s, IWindow c, WindowToken token,
        ...
        if ((mAttrs.type >= FIRST_SUB_WINDOW &&
            ...
            int layerNumber;
            if (attachedWindow.mAttrs.type == TYPE_SYSTEM_ALERT
                ...
                // This window type normally stacks on top of the TYPE_SYSTEM_ALERT
                // window we create for the background presentation.
            ...
            mBaseLayer = layerNumber * WindowManagerService.TYPE_LAYER_MULTIPLIER
            ...
            int layerNumber;
            if (a.type == TYPE_SYSTEM_ALERT && !displayContent.isDefaultDisplay) {
                // Special case for background presentation.
                // There is now a Presentation created as TYPE_KEYGUARD_DIALOG by
                // the lock screen to ensure privacy while entering your PIN.
                // This window type normally stacks on top of the TYPE_SYSTEM_ALERT
