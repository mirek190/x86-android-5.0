...
import com.android.internal.telephony.cdma.CDMAPhone; //jw
import com.android.internal.telephony.PhoneConstants;
import com.android.internal.telephony.RILConstants;
import com.android.internal.telephony.uicc.IccRecords;
import com.android.internal.telephony.uicc.RuimRecords; //jw
...
public final class DcTracker extends DcTrackerBase {
    ...
    protected void onUpdateIcc() {
		...
		if(DBG) log("onUpdateIcc....jw...."); //jw
        IccRecords newIccRecords = null;
     	//   IccRecords newIccRecords = getUiccRecords(UiccController.APP_FAM_3GPP);

	
    	if (mPhone instanceof GSMPhone) {
             newIccRecords = getUiccRecords(UiccController.APP_FAM_3GPP); //jw for GSM situation
		}

		if (mPhone instanceof CDMAPhone) {
             newIccRecords = getUiccRecords(UiccController.APP_FAM_3GPP2); //jw for CDMA situation
		}
	
		if(DBG) log("newIccRecords = " + newIccRecords); //jw
        IccRecords r = mIccRecords.get();
        if (r != newIccRecords) {
            if (r != null) {
