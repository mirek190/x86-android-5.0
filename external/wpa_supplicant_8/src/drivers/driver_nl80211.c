...
static int nl80211_set_param(void *priv, const char *param)
{
	...
	if (os_strstr(param, "force_single_radio=1")) {
		struct i802_bss *bss = priv;
		struct wpa_driver_nl80211_data *drv = bss->drv;

		wpa_printf(MSG_DEBUG, "nl80211: Force single radio\n");
...
static const char * nl80211_get_radio_name(void *priv)
{
	...
	wpa_printf(MSG_DEBUG, "nl80211: Single radio %d phy name %s\n",
		   drv->single_radio, drv->phyname);
