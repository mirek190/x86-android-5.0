...
typedef struct phHal4Nfc_TrcvCtxtInfo{
    ...
    pphHal4Nfc_SendCallback_t        pSendCb;
     /*Upper layer's receive callback*/
    pphHal4Nfc_ReceiveCallback_t     pRecvCb;
...
typedef struct phHal4Nfc_UpperLayerInfo{
    ...
    /* Upper layer's Context for Disconnect operation completion */
    void                            *psUpperLayerDisConCtxt;
    /* Upper layer's Context for Config Discovery operation completion */
...
typedef struct phHal4Nfc_Hal4Ctxt{
    ...
    /* Discovery Mode Flag */
    uint8_t                          hal_discovery_mode;
    /* Maximum frame length to be use for transaction */
    uint16_t                         RemTransactLen;
...
#if    ( NXP_KOVIO == 1 )
extern void phHal4Nfc_TargetReleaseComplete(
                                            phHal4Nfc_Hal4Ctxt_t *Hal4Ctxt,
                                            void                 *pInfo
                                           );
#endif/*NXP_KOVIO*/
