                                    ...
                                    )
{
    ...
    if(psNotificationInfo->type == NFC_EVENT_NOTIFICATION )
    {
        if (uNotificationInfo.psEventInfo->eventType == NFC_EVT_ACTIVATED)
        {
            Hal4Ctxt->sTgtConnectInfo.EmulationState = NFC_EVT_ACTIVATED;
        }
        if (uNotificationInfo.psEventInfo->eventType == NFC_EVT_DEACTIVATED)
        {
