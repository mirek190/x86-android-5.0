...
/***************************** Macros *******************************/
 /**< For Configuring the Interface Mode */
#define NFC_HIF_MODE_OFF 0x00
#define NFC_HIF_MODE_ON  0x01
#define NFC_HIF_MODE_FW  0x02
#define NFC_HIF_MODE_RST 0x03
 ...
 *                             \ref phDal4Nfc_Register() function
 ...
 *                             through the \ref phDal4Nfc_Register() function
 * \param[in]  pHwRef          information of the hardware.
 ...
 *ClientApp=>phDal4Nfc    [label="phDal4Nfc_DeferredCb()",URL="\ref  pphLibNfc_DeferredCallback_t()"];
 *phDal4Nfc=>UpperLayer    [label="send_complete",URL="\ref pphNfcIF_Transact_Completion_CB_t()"];
 *ClientApp<<phDal4Nfc    [label="NFCSTATUS_SUCCESS"];
 *\endmsc
 */
 extern
 ...
 *phDal4Nfc=>phDal4Nfc [label="phDal4Nfc_DeferredCall()",URL="\ref    phDal4Nfc_DeferredCall()"];
 *ClientApp=>phDal4Nfc    [label="phDal4Nfc_DeferredCb()",URL="\ref  pphLibNfc_DeferredCallback_t()"];
 *phDal4Nfc=>UpperLayer    [label="receive_complete",URL="\ref  pphNfcIF_Transact_Completion_CB_t()"];
 *ClientApp<<phDal4Nfc    [label="NFCSTATUS_SUCCESS"];
