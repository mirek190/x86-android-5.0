 ...
 * \def PH_OSALNFC_MESSAGE_BASE
 * NFC Message Base number for inter thread communication.
 */
 ...
 *
 * \retval :            Handle to the opened file. NULL if failed.
 */
 ...
 *
 * \param[in] handle     Handle of a previous opened file.
 * \param[in] symbol     Symbol's name
 *
 * \retval :              Address where the symbol is loaded
 */
 ...
 * \brief Close a file.
 *
 * \param[in] handle     Handle of the file to close
 *
 * \retval Zero value:   0 on success, non-zero on error
 */
