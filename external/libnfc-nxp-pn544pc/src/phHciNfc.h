 ...
 */
/*@{*/
#define PH_HCINFC_FILEREVISION "$Revision: 1.41 $" /**< \ingroup grp_file_attributes */
#define PH_HCINFC_FILEALIASES  "$Aliases:  $"  /**< \ingroup grp_file_attributes */
/*@}*/
...
typedef struct phHciNfc_XchgInfo
{
    ...
    /** \internal Exchange/Data Transfer timeout
     *   for the Exchanging the Buffer
     */
    uint16_t                     timeout;

    /** \internal RF Meta Chaining Information */
    uint8_t                      more_info;
 ...
 *                                      that needs to be performed on the device.
 *  \param[out] p_value_set             Value set after Configuration is updated in
 *                                      this Parameter.
 *
 *
...
// HECI Mod
extern void phHciNfc_EmergencyRelease();
// End HECI Mod
