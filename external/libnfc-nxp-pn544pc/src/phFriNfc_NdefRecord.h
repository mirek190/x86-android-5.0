 ...
 * - \b Extraction: The calling function(-ality) receives the NDEF data of an extracted
 *                     record in this structure.
 * - \b Composition The caller is required to specify the data to write within this structure
