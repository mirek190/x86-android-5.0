...
*/
/*@{*/
#define PHHCINFC_FELICA_FILEREVISION "$Revision: 1.5 $" /**< \ingroup grp_file_attributes */
#define PHHCINFC_FELICA_FILEALIASES  "$Aliases:  $"   /**< \ingroup grp_file_attributes */
/*@}*/
...
* \ingroup grp_hci_nfc
*
*   The phHciNfc_Felica_Poll_Request function is to  poll the felica tag
*   in the field and get the information about the tag present.
*
*   \param[in]  psHciContext            psHciContext is the pointer to HCI Layer
*                                       context Structure.
*   \param[in]  pHwRef                  pHwRef is the Information of
