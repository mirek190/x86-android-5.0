...
#define DESFIRE_TRANSACTION_TIMEOUT                         650U
...
static NFCSTATUS phFriNfc_Desf_HSendTransCmd(phFriNfc_sNdefSmtCrdFmt_t *NdefSmtCrdFmt)
{
    ...
    NFCSTATUS status =  NFCSTATUS_SUCCESS;
    uint16_t  desfire_timeout = DESFIRE_TRANSACTION_TIMEOUT;
    ...
    *NdefSmtCrdFmt->SendRecvLength = PH_FRINFC_SMTCRDFMT_MAX_SEND_RECV_BUF_SIZE;
    ...
    (void)phFriNfc_OvrHal_SetParam(NdefSmtCrdFmt->LowerDevice,
                             OVRHAL_TIMEOUT_CONFIG,
                             &desfire_timeout);
