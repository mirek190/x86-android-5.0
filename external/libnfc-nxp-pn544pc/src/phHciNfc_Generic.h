 ...
 */
/*@{*/
#define PHHCINFC_GENERIC_FILEREVISION "$Revision: 1.77 $" /**< \ingroup grp_file_attributes */
#define PHHCINFC_GENERIC_FILEALIASES  "$Aliases:  $"     /**< \ingroup grp_file_attributes */
/*@}*/
/*
...
typedef struct phHciNfc_sContext{
    ...
    */
    ...
    /** \internal Verify the Gate information  */
    volatile uint8_t            gate_verify;
