...
*/
/*@{*/
#define PHHCINFC_JEWEL_FILEREVISION "$Revision: 1.5 $" /**< \ingroup grp_file_attributes */
#define PHHCINFC_JEWEL_FILEALIASES  "$Aliases:  $"   /**< \ingroup grp_file_attributes */
/*@}*/
