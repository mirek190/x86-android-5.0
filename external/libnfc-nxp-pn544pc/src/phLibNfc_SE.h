...
typedef struct phLibNfc_SeCtxt
{
    ...
    /* Field Event Filter Timer ID */
    uint32_t                            uFieldEventTimerId;

    /* Field Event Timer State */
    uint8_t                         uFieldEventTimerStarted;

    /* Last sent field event notification to application */
    uint8_t           uFieldEventSent;

    /* Last received field event notification from CLF */
    uint8_t           uFieldEventRcvd;
