    ...
    switch(cmdtype)
    {
        ...
        case phLlcNfc_e_rej:
        {
            ...
            else
            {
                ...
                /* Stop all the timers as reject is received */
                phLlcNfc_StopAllTimers ();
                /* Reset the n(s) position to the start position, as remaining frames shall
                 needs to be resent */
                ps_frame_info->n_s = ps_store_frame->start_pos;
            }
