                        ...
                        )
{
    ...
    else
    {
        ...
        {
            ps_swp_info->p_default_mode = p_mode;
            ps_pipe_info->reg_index = NXP_SWP_DEFAULT_MODE_INDEX;
            status = phHciNfc_Send_Generic_Cmd(psHciContext, pHwRef,
                                    ps_swp_info->pipe_id,
                        ...
                        )
{
    ...
    else
    {
        ...
        {
            ps_swp_info->p_uicc_status = p_status;
                          ...
                          )
{
    ...
    switch(index)
    {
        case NXP_SWP_DEFAULT_MODE_INDEX:
        {
            ...
            ps_swp_info->default_mode =  *reg_value ;
            if ( NULL != ps_swp_info->p_default_mode)
                    *ps_swp_info->p_default_mode = *reg_value;
            break;
        }
            /* Get the Status of the UICC Connection */
        case NXP_SWP_STATUS_INDEX:
        {
            ...
            switch(ps_swp_info->uicc_status)
            {
               case UICC_CONNECTED:
               case UICC_CONNECTION_INACTIVE:
               {
                   psHciContext->p_hw_ref->uicc_connected = TRUE;
                   break;
               }
               ...
               default:
               {
                   psHciContext->p_hw_ref->uicc_connected = FALSE;
                   break;
               }

            }
            if ( NULL != ps_swp_info->p_uicc_status)
                    *ps_swp_info->p_uicc_status = *reg_value;
            break;
        }
