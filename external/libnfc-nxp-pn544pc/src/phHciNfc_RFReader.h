 ...
 */
/*@{*/
#define PHHCINFC_RF_READER_FILEREVISION "$Revision: 1.18 $" /**< \ingroup grp_file_attributes */
#define PHHCINFC_RF_READER_FILEALIASES  "$Aliases:  $"   /**< \ingroup grp_file_attributes */
/*@}*/
...
#define NXP_EVT_KOVIO_TAG_EVENT         0x12
#define NXP_EVT_KOVIO_TAG_LOST          0x13

#define NXP_EVT_WI_WTX                  0x09
/* Commands from ETSI HCI Specification */
#define WR_XCHGDATA                     0x10U
#define NXP_3B_RAW_XCH                  0X22U

/* NXP Additional Commands apart from ETSI HCI Specification */

/* Command to Exchange the Data with certain Extensions */
#define NXP_WR_XCHG_DATA_EXT            0x11U
...
/* Event to Notify the Removal of the Card in
 * Special Polling Mode */
#define NXP_EVT_TARGET_REMOVED          0x36U
...
#define NXP_EVT_WR_SND_DATA             0x01U
#define NXP_EVT_WR_RCV_DATA             0x04U
#define NXP_EVT_WR_CONTINUE_MI          0x05U

/* value 3.310546875 is the outcome of (13.56/0x1000U) and convert into milli seconds */
#define NXP_NFC_TIMER_CONSTANT         (3.310546875)
