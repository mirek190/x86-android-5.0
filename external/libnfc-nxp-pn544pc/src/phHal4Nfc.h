...
/** HAL Implementation Version Macros : Updated for every feature release of
    HAL functionality */
#define PH_HAL4NFC_VERSION                            0x0AU
#define PH_HAL4NFC_REVISION                           0x05U
#define PH_HAL4NFC_PATCH                              0x00U
#define PH_HAL4NFC_BUILD                              0x00U

/** HAL Interface Version Macros : Updated for every external release of
    HAL Interface */
#define PH_HAL4NFC_INTERFACE_VERSION                  0x01U
#define PH_HAL4NFC_INTERFACE_REVISION                 0x0AU
#define PH_HAL4NFC_INTERFACE_PATCH                    0x00U
#define PH_HAL4NFC_INTERAFECE_BUILD                   0x00U

/**Maximum length of receive buffer maintained by HAL*/
#define PH_HAL4NFC_MAX_RECEIVE_BUFFER                0x10010U
...
typedef enum{
    ...
    eRegisterSPMDiscovery,    /**<For Tag Discovery notification in Special Polling Mode */
