...
typedef enum phNfc_eOverHal_SetParam
{
    OVRHAL_TIMEOUT_CONFIG = 0x01,
    OVRHAL_INVALID_PARAM
}phNfc_eOverHal_SetParam_t;
...
NFCSTATUS phFriNfc_OvrHal_SetParam(phFriNfc_OvrHal_t         *OvrHal,
