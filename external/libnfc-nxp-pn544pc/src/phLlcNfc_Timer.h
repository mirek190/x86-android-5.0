...
*/
/*@{*/
#define PH_LLCNFC_TIMER_FILEREVISION "$Revision: 1.15 $" /**< \ingroup grp_hal_nfc_llc_helper */
#define PH_LLCNFC_TIMER_FILEALIASES  "$Aliases:  $"     /**< \ingroup grp_hal_nfc_llc_helper */
/*@}*/
/*************************** Includes *******************************/
