...
// **************************************** Log functions
/**
 * Wrapping function for Log message.
 * @param format
 */
//void framework_Log(const char* format, ...);
#define framework_Log ALOGD
/**
 * Wrapping function for Warning message.
 * @param format
 */
void framework_Warn(const char* format, ...);
#define framework_Warn ALOGW
/**
 * Wrapping function for Error message.
 * @param format
 */
void framework_Error(const char* format, ...);
#define framework_Error ALOGE
/**
 * Log a buffer to log output as Hexadecimal + ASCII display.
 * @param buffer
 * @param size
 */
