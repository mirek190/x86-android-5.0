...
#HECI Specific
LOCAL_SRC_FILES += ext/src/core/phDownloadWrapperCore.c
LOCAL_SRC_FILES += ext/src/core/phHciWrapperCore.c
LOCAL_SRC_FILES += ext/src/port/intel/WaiterNotifier.c
LOCAL_SRC_FILES += ext/src/port/intel/phDownloadWrapper_intel.c
LOCAL_SRC_FILES += ext/src/port/intel/phHciWrapper_intel.c
LOCAL_SRC_FILES += ext/src/port/intel/phHECICommunicationLayer.c
LOCAL_SRC_FILES += ext/src/port/intel/HECI/HECICore.c
LOCAL_SRC_FILES += ext/src/port/intel/HECI/HECILinux.c
LOCAL_SRC_FILES += ext/src/port/intel/linux/phOsEvent_linux.c
LOCAL_SRC_FILES += ext/src/port/intel/fakeStack.c
LOCAL_SRC_FILES += ext/src/port/linux/phNfc_callback.c
LOCAL_SRC_FILES += ext/src/tools/core/framework_Parcel.c
LOCAL_SRC_FILES += ext/src/tools/portinglayer/linux/framework_Allocator.c
LOCAL_SRC_FILES += ext/src/tools/portinglayer/linux/framework_log.c
LOCAL_SRC_FILES += ext/src/tools/portinglayer/linux/framework_mutex.c
LOCAL_SRC_FILES += ext/src/tools/portinglayer/linux/framework_sem.c
LOCAL_SRC_FILES += ext/src/tools/portinglayer/linux/framework_thread.c
LOCAL_SRC_FILES += ext/src/tools/portinglayer/linux/framework_Timer.c
...
LOCAL_CFLAGS += -I$(TARGET_OUT_HEADERS)/libtxei
...
LOCAL_CFLAGS += -DDEBUG -DDNLD_TRACE
...
LOCAL_CFLAGS += -I$(LOCAL_PATH)/ext/src
LOCAL_CFLAGS += -I$(LOCAL_PATH)/ext/src/tools

LOCAL_MODULE:= libnfc_pn544pc
LOCAL_MODULE_TAGS := optional
LOCAL_SHARED_LIBRARIES := libcutils libnfc_ndef_pn544pc libdl libhardware liblog libtxei
...
LOCAL_MODULE:= libnfc_ndef_pn544pc
LOCAL_MODULE_TAGS := optional
