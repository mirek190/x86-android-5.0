...
*
* $Date: Thu Oct 27 11:36:57 2011 $
* $Author: ravindrau $
* $Revision: 1.47 $
* $Aliases: NFC_FRI_1.1_WK1146_C2 $
*
*/
...
/*@{*/
#define PH_NFC_CONFIG_FILEREVISION "$Revision: 1.47 $" /**< \ingroup grp_file_attributes */
#define PH_NFC_CONFIG_FILEALIASES  "$Aliases: NFC_FRI_1.1_WK1146_C2 $"     /**< \ingroup grp_file_attributes */
/*@}*/
...
#define DEFAULT_SESSION           "NXP-NFC3"
#endif

/**< Default Session ID Size for Initialisation */
#ifndef DEFAULT_SESSION_SIZE
#define DEFAULT_SESSION_SIZE      0x08U
#endif
...
#define NXP_NFCIP_PSL_BRS_DEFAULT       0x92U
#endif

#ifndef NXP_NFC_ISO14443_4A_PPS_DEFAULT
#define NXP_NFC_ISO14443_4A_PPS_DEFAULT 0x03U
#endif

#ifndef NXP_NFCIP_DID_DEFAULT
#define NXP_NFCIP_DID_DEFAULT       0x00U
#endif
...
#ifndef NXP_NFC_HCI_TIMER_DISABLE
#define NXP_NFC_HCI_TIMER_DISABLE    0xFBFBFBFB
#endif
#ifndef NXP_NFC_WTX_TIMEOUT
#define NXP_NFC_WTX_TIMEOUT          0x0A00 /*    (0x0a *  257) ms  */
#endif
...
#define LINK_ACK_TIMEOUT                150U
#endif


/**< Defines Firmware Download Completion Timeout value ,
  * if FW_DOWNLOAD_TIMER is 0x01U then value is 120000(milliseconds)
  * if FW_DOWNLOAD_TIMER is 0x02U then value is  20000(milliseconds)
  */


#ifndef NXP_DNLD_COMPLETE_TIMEOUT
#define NXP_DNLD_COMPLETE_TIMEOUT         15000U
#endif
...
/* NXP_UICC = 0x00U UICC Handle is valid only if the UICC SIM
 *  is discovered during the Initialisation
 */
/* NXP_UICC = 0x01U UICC Handle is valid always even if the UICC
 * SIM is not discovered.
 */
#if !defined(NXP_UICC)
#define NXP_UICC 0x00
#endif

/* NXP_SMX = 0x00U SMX Handle is valid only if the SMARTMX
 *  is discovered during the Initialisation
 */
/* NXP_SMX = 0x01U SMX Handle is valid always even if the
 * SmartMX Chip is not present.
 */

#if !defined(NXP_SMX)
#define NXP_SMX 0x00
#elif defined(NXP_HAL_ENABLE_SMX)
#define NXP_SMX 0x01
#elif !defined (NXP_HAL_ENABLE_SMX) && (NXP_SMX == 0x01)
/* The SmartMX is detected run-time with C3 Version */
#define NXP_HAL_ENABLE_SMX
#elif defined (NXP_SMX) && (NXP_SMX != 0x00)
/* The SmartMX is detected run-time with C3 Version */
#else
#define NXP_SMX 0x00
#endif

#if !defined(NXP_NFC_SMX_TRANSACTION_EVENTS)
#define NXP_NFC_SMX_TRANSACTION_EVENTS 0x07
#endif


/**< Macro to Enable the SWP Protocol
 * to detect UICC During Initialisation */
#ifndef NXP_SWP_INIT_ACTIVATION
/* 0x00U SWP Activation is Skipped during Intialisation */
/* 0x01U SWP is Activated during Initialisation */
#define NXP_SWP_INIT_ACTIVATION 0x01
#endif


#ifndef NXP_NFC_HCI_TIMER
#define NXP_NFC_HCI_TIMER       1
#define NXP_NFC_HCI_TIMEOUT     0x3000
#endif


#if !defined(NXP_NFC_HW_EE_ADDR_TABLE_CFG)
#define NXP_NFC_HW_EE_ADDR_TABLE_CFG 0x00U
#endif
...
#define NXP_UICC_CE_RIGHTS              0x07U
#endif
...
#if  (NXP_UICC_CE_RIGHTS & 0x08U)
#define NXP_NFC_FELICA_CLT_SUPPORT      0x01U
#else
...
/*
 *****************************************************************
  DO NOT MODIFY THE MACROS BELOW ELSE THE STACK BEHAVIOR WOULD
  BE UNDEFINED
 *****************************************************************
 */
...
#ifndef NXP_NFC_EXT_APDU_SUPPORT
#define NXP_NFC_EXT_APDU_SUPPORT   0x01
#endif

/**< Macro to Enable the Felica Feature */
#define TYPE_FELICA

#define NFC_TYPE_3B_RAW
/* By Default this will be disabled to maintain the
 * backward compatibility. If Enabled, setting of the
 * FelicaPollSystemCode in the phHal_sADD_Cfg_t is mandatory
 */

#ifndef FELICA_SYS_CODE_RESPONSE_ENABLE
#define FELICA_SYS_CODE_RESPONSE_ENABLE 0x01U
#endif
#ifndef NXP_NFC_POLL_FELICA_SYSCODE
#define NXP_NFC_POLL_FELICA_SYSCODE 0x00U
#endif
...
#ifndef NXP_HAL_PL_STATE_DEBUG
#define NXP_HAL_PL_STATE_DEBUG 0x00U
#endif

/**< Macro to Enable the SWP Feature
 * to detect UICC During Initialisation */
#define ENABLE_SWP

#if (NXP_UICC == 0x01)
#define NXP_HAL_SE_UICC 0x01
#else
#define NXP_HAL_SE_UICC 0x00
#endif

/**< Macro to Enable the WI Interface
 * to detect WI During Initialisation */
#define ENABLE_WI
...
/* Disable the SmartMX Enabling
 * if the WI interface is not enabled
 */

#if defined (NXP_HAL_ENABLE_SMX) && !defined (ENABLE_WI)
#undef NXP_HAL_ENABLE_SMX
#endif
...
#define NXP_FW_INTEGRITY_CHK    0x01U

/*  To check the Download Phase */
#define NXP_FW_DNLD_CHECK_PHASE

/* To specify the Maximum TX/RX Len */
// HECI MOD
// #define NXP_FW_MAX_TX_RX_LEN   0x200U
#define NXP_FW_MAX_TX_RX_LEN   0x20U
// END HECI MOD

/* Delay After the Firmware Download Soft Reset */

#ifndef NXP_FW_RESET_DELAY
#define NXP_FW_RESET_DELAY     0x1000U
#endif
...
#if !defined(NXP_NFC_POLL_AUTONOMOUS)
#define NXP_NFC_POLL_AUTONOMOUS 0x01
#endif /* defined(NXP_NFC_POLL_AUTONOMOUS)*/
...
#ifndef NXP_NFC_SMX_SECONDS_DELAY
#define NXP_NFC_SMX_SECONDS_DELAY(x)   ;
#endif

#ifndef NXP_SMX_RECOVERY_DELAY
#define NXP_SMX_RECOVERY_DELAY      0x0CU  /* 12 Seconds delay to allow the SmartMX
                                              to complete the Recovery operations */
#endif
 ...
 * 0x00 ----> Default PN544 Configuration;
 * 0x01 ----> Update both IFC RX (NXP_NFC_IFC_CONFIG_DEFAULT) and
 *             TX (NXP_NFC_IFC_TX_CONFIG_DEFAULT) Timeout ;
 */

#ifndef NXP_NFC_IFC_TIMEOUT
#define NXP_NFC_IFC_TIMEOUT            0x0000U
#endif


/* Macro to Enable the Interface Character Timeout Configuration
 * ( Timeout for HOST Transmitting data to PN544 )
 */

#ifndef NXP_NFC_IFC_TX_CONFIG_DEFAULT
#define NXP_NFC_IFC_TX_CONFIG_DEFAULT     0x0096U /* PN544 Default: 0x0096U */
#endif

/* Macro to Enable the Interface Character Timeout Configuration
 * ( Timeout for PN544 Transmitting data to HOST )
 */

#ifndef NXP_NFC_IFC_CONFIG_DEFAULT
#define NXP_NFC_IFC_CONFIG_DEFAULT     0x00U /* PN544 Default: 0x203AU */
#endif
...
/* Macro to Enable the Configuration of Target
 * speed during Discovery configuration
 */
#ifndef NXP_NFC_TGT_SPEED_CONFIG
#define NXP_NFC_TGT_SPEED_CONFIG 0x01U
#endif

/* Macro to Enable the Configuration of Initiator
 * speed during Discovery configuration
 */
#define NXP_NFC_INITIATOR_SPEED_CONFIG 0x01U
