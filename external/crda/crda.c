...
#if defined(CONFIG_LIBNL20) && defined(CONFIG_GOOGLE_LIBNL20)
int nl_wait_for_ack(struct nl_sock *sk){return 0;}
#endif
...
int main(int argc, char **argv)
{
	...
	const char *regdb_paths[] = {
		...
		"/system/etc/wifi/crda/regulatory.bin", /* alternative for android */
		NULL
	};
