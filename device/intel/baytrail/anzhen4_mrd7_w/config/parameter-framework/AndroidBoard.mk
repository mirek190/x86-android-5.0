...
include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.audio.anzhen4_mrd7_w
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES :=  \
    parameter-framework.audio.anzhen4_mrd7_w.nodomains \
    AudioConfigurableDomains.xml
include $(BUILD_PHONY_PACKAGE)

include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.audio.anzhen4_mrd7_w.nodomains
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES :=  \
...
$(LOCAL_BUILT_MODULE): MY_SRC_FILES := \
        ...
        $(LOCAL_PATH)/XML/Settings/Audio/anzhen4_mrd7_w_routing_realtek5640.pfw \
        $(LOCAL_PATH)/XML/Settings/Audio/anzhen4_mrd7_w_routing_xmm.pfw
...
include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.routeMgr.anzhen4_mrd7_w
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES :=  \
    parameter-framework.routeMgr.anzhen4_mrd7_w.nodomains \
...
include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.routeMgr.anzhen4_mrd7_w.nodomains
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES := \
    RouteClass.xml \
    RouteSubsystem.xml \
...
include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.vibrator.anzhen4_mrd7_w
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES :=  \
