...
# Overrides
PRODUCT_DEVICE := anzhen4_mrd8
PRODUCT_MODEL := anzhen4_mrd8
...
PRODUCT_COPY_FILES += \
        ...
        $(foreach file,$(wildcard $(DEVICE_CONF_PATH)/camera3_profiles*.xml),$(file):system/etc/$(notdir $(file)))
...
PRODUCT_COPY_FILES += \
    ...
    $(FRAMEWORK_ETC_PATH)/android.hardware.camera.autofocus.xml:$(PERMISSIONS_PATH)/android.hardware.camera.autofocus.xml \
