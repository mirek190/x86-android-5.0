...
ifeq ($(BOARD_USES_WISKY_MONO),true)
$(LOCAL_BUILT_MODULE): MY_SRC_FILES := \
        ...
        $(LOCAL_PATH)/XML/Settings/Audio/anzhen4_mrd7_routing_realtek5640_wisky_mono.pfw \
...
include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.routeMgr.anzhen4_mrd7
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES :=  \
    parameter-framework.routeMgr.anzhen4_mrd7.nodomains \
...
include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.routeMgr.anzhen4_mrd7.nodomains
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES := \
    RouteClass.xml \
    RouteSubsystem.xml \
