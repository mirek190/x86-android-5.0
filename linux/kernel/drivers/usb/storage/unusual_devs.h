...
/*ZTE CD-ROM PRODUCT ID are added by Mario Lu <mario.lu@intel.com>*/
...
UNUSUAL_DEV(0x19d2, 0x0150, 0x0000, 0x0000,
		"ZTE REJECT CDROM",
		"USB MMC Storage",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),
...
UNUSUAL_DEV(0x19d2, 0x0154, 0x0000, 0x0000,
		...
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),
UNUSUAL_DEV(0x19d2, 0x0166, 0x0000, 0x0000,
		"ZTE REJECT CDROM",
		"USB MMC Storage",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),
UNUSUAL_DEV(0x19d2, 0x1007, 0x0000, 0x0000,
		"ZTE REJECT CDROM",
		"USB MMC Storage",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),
UNUSUAL_DEV(0x19d2, 0x1009, 0x0000, 0x0000,
		"ZTE REJECT CDROM",
		"USB MMC Storage",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),
UNUSUAL_DEV(0x19d2, 0x1237, 0x0000, 0x0000,
		"ZTE REJECT CDROM",
		"USB MMC Storage",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),
...
UNUSUAL_DEV(0x19d2, 0x1243, 0x0000, 0x0000,
		...
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),
UNUSUAL_DEV(0x19d2, 0x1562, 0x0000, 0x0000,
		"ZTE REJECT CDROM",
		"USB MMC Storage",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),
UNUSUAL_DEV(0x19d2, 0x1588, 0x0000, 0x0000,
		"ZTE REJECT CDROM",
		"USB MMC Storage",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),

UNUSUAL_DEV(0x19d2, 0x1593, 0x0000, 0x0000,
		"ZTE REJECT CDROM",
		"USB MMC Storage",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),

UNUSUAL_DEV(0x19d2, 0x1595, 0x0000, 0x0000,
		"ZTE REJECT CDROM",
		"USB MMC Storage",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),

UNUSUAL_DEV(0x19d2, 0x1597, 0x0000, 0x0000,
		"ZTE REJECT CDROM",
		"USB MMC Storage",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),

UNUSUAL_DEV(0x19d2, 0x1599, 0x0000, 0x0000,
		"ZTE REJECT CDROM",
		"USB MMC Storage",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_zte_init,
		0),
