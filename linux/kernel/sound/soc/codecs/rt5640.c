...
/*	{RT5640_I2S1_SDP	, 0xD000},//change IIS1 and IIS2*/
	/*record */
#if defined(CONFIG_MRD7) || defined(CONFIG_MRD8)
	#if defined(CONFIG_WISKY_MONO_DESIGN)
	{RT5640_IN1_IN2, 0x50c0},	/*IN1 boost 40db and differential mode - main mic */
	#else
...
#if defined(CONFIG_MRD7) || defined(CONFIG_MRD8)
	#if defined(CONFIG_WISKY_MONO_DESIGN)
	{RT5640_REC_L2_MIXER, 0x007d},	/*Mic1 -> RECMIXL default set main mic, user space control to switch to hs */
	{RT5640_REC_R2_MIXER, 0x007d},	/*Mic1 -> RECMIXR main mic*/
	#else
