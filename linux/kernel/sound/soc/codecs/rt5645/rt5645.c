...
#if defined(JD1_MODE_0) && defined(JD_MODE_1)
#error("select only one kind of jd1 mode!!");
#endif
...
#ifdef JD1_MODE_1
	{ RT5645_A_JD_CTRL1	, 0x0002 },/* for combo jack 1.8v mode 0*/
#endif
	{RT5645_GEN_CTRL2	, 0x0068 },
	/* playback */
	{ RT5645_CHARGE_PUMP	, 0x0e06 },
...
#ifdef JD1_FUNC
#ifdef JD1_MODE_1
	{ RT5645_IRQ_CTRL2	, 0x0210 },
#endif
#ifdef JD1_MODE_0
	{ RT5645_IRQ_CTRL2	, 0x02D0 },
#endif
	{ RT5645_JD_CTRL3	, 0x70c8 },
	{ RT5645_PWR_ANLG2	, 0x0004 }, /* power on JD1 */
	{ RT5645_GEN_CTRL3	, 0x1080 },
...
*/
		...
		case 0x2: /* iPhone type*/
			/* for push button */
			reg63 &= 0xfffc;
			reg63 |= (RT5645_PWR_MB | 0x3);
			reg64 |= (RT5645_PWR_JD1 | RT5645_PWR_MB1 |
					RT5645_PWR_MB2 | RT5645_PWR_BST1);
			reg65 |= RT5645_PWR_LDO2;
...
/* IN1/IN2 Input Type */
static const char * const  const rt5645_input_mode[] = {
...
static const char * const  const rt5645_data_select[] = {
...
static const char * const  const rt5645_dac1_src[] = {
...
static const char * const  const rt5645_dac12_src[] = {
...
/* INL/R source */
static const char * const  const rt5645_inl_src[] = {
	"IN2P", "MonoP"
};
...
static const char * const  const rt5645_inr_src[] = {
	"IN2N", "MonoN"
};
...
/* Stereo1 ADC source */
/* MX-27 [12] */
static const char * const  const rt5645_stereo_adc1_src[] = {
	"DAC MIX", "ADC"
};
...
/* MX-27 [11] */
static const char * const  const rt5645_stereo_adc2_src[] = {
	"DAC MIX", "DMIC"
};
...
/* MX-27 [8] */
static const char * const  const rt5645_stereo_dmic_src[] = {
	"DMIC1", "DMIC2"
};
...
/* Mono ADC source */
/* MX-28 [12] */
static const char * const  const rt5645_mono_adc_l1_src[] = {
	"Mono DAC MIXL", "ADC"
};
...
/* MX-28 [11] */
static const char * const  const rt5645_mono_adc_l2_src[] = {
	"Mono DAC MIXL", "DMIC"
};
...
/* MX-28 [8] */
static const char * const  const rt5645_mono_dmic_src[] = {
	"DMIC1", "DMIC2"
};
...
/* MX-28 [4] */
static const char * const  const rt5645_mono_adc_r1_src[] = {
	"Mono DAC MIXR", "ADC"
};
...
/* MX-28 [3] */
static const char * const  const rt5645_mono_adc_r2_src[] = {
	"Mono DAC MIXR", "DMIC"
};
	...
	if (on) {
		if (hp_amp_power_count <= 0) {
			...
			snd_soc_update_bits(codec, RT5645_PWR_ANLG1,
				...
				RT5645_PWR_HA, RT5645_PWR_HP_L |
				RT5645_PWR_HP_R | RT5645_PWR_HA);
			mdelay(5);
			snd_soc_update_bits(codec, RT5645_PWR_ANLG1,
...
#if 0/* def JD1_FUNC */
/* we must keep enable JD power to alway enable JD */
...
static int rt5645_probe(struct snd_soc_codec *codec)
{
	...
	rt5645->codec = codec;
	rt5645->combo_jack_en = false; /* enable combo jack */
