...
#ifdef ILI_UPDATE_FW
#define CHIP_ILITEK_2139     	2139
#define CHIP_ILITEK_2839		2839
#define CHIP_ILITEK_2303		2303218

unsigned char CTPM_FW2139[]={
	#include "ILI21390CN079I0405_Header.ili"
};
unsigned char CTPM_FW2839[]={
	#include "ILI28390CN079I0405_Header.ili"
};
unsigned char CTPM_FW2303[]={
	#include "ILI23030IN101O0002_CHKSUM.ili"
};
#endif
