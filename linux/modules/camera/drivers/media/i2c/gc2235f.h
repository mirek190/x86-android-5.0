...
/*
 * gc2235f System control registers
 */
...
#define GC2235_DRIVER	"gc2235f"
#define GC2235_NAME	"gc2235f"
...
struct max_res gc2235f_max_res[] = {
	[0] = {
...
/**
 * struct gc2235f_reg - MI sensor  register format
 ...
 */
struct gc2235f_reg {
        enum gc2235f_tok_type type;
        u16 sreg;
        u32 val;        /* @set value for read/mod/write, @mask */
};

struct gc2235f_fps_setting {
        int fps;
        unsigned short pixels_per_line;
        unsigned short lines_per_frame;
};

struct gc2235f_resolution {
        u8 *desc;
        const struct gc2235f_reg *regs;
        int res;
        int width;
        int height;
        int fps;
...
struct gc2235f_settings {
	struct gc2235f_reg const *init_settings;
	struct gc2235f_resolution *res_preview;
	struct gc2235f_resolution *res_still;
	struct gc2235f_resolution *res_video;
	int n_res_preview;
	int n_res_still;
	int n_res_video;
};

static struct gc2235f_reg const gc2235f_720p_30fps[] = {
...
static struct gc2235f_reg const gc2235f_1600x1200_30fps[] = {
	{GC2235_8BIT, 0xfe, 0x00},
	{GC2235_8BIT, 0x0a, 0x02},
	{GC2235_8BIT, 0x0c, 0x00},
	{GC2235_8BIT, 0x0d, 0x04},
	{GC2235_8BIT, 0x0e, 0xd0},//d0 -> c0
	{GC2235_8BIT, 0x0f, 0x06}, 
	{GC2235_8BIT, 0x10, 0x58},//58->50
...
static struct gc2235f_reg const gc2235f_still_1600x1200_30fps[] = {
	{GC2235_8BIT,0xfe, 0x00},
	{GC2235_8BIT,0x0a, 0x02},
	{GC2235_8BIT,0x0c, 0x00},
	{GC2235_8BIT,0x0d, 0x04},
	...
	{GC2235_8BIT,0x0f, 0x06}, 
	{GC2235_8BIT,0x10, 0x58},	//win_w 1624

	{GC2235_8BIT,0x90, 0x01},
	{GC2235_8BIT,0x92, 0x02},
	{GC2235_8BIT,0x94, 0x00},
	{GC2235_8BIT,0x95, 0x04},	//1216
	{GC2235_8BIT,0x96, 0xc0},	
	{GC2235_8BIT,0x97, 0x06},
	{GC2235_8BIT,0x98, 0x50},	//1616
...
static struct gc2235f_reg const gc2235f_1280_30fps[] = {
	{GC2235_8BIT, 0xfe, 0x00},
	{GC2235_8BIT, 0x0a, 0x98},
	{GC2235_8BIT, 0x0c, 0x00},
	{GC2235_8BIT, 0x0d, 0x03},//0x02},
	{GC2235_8BIT, 0x0e, 0xa4},//0xf0},//932
	{GC2235_8BIT, 0x0f, 0x06},//0x05}, 
	{GC2235_8BIT, 0x10, 0x50},//0x10},	//win_w 1624

	{GC2235_8BIT, 0x90, 0x01},
	{GC2235_8BIT, 0x92, 0x02},//;0x02},
	{GC2235_8BIT, 0x94, 0x00},//0x00},//150
	{GC2235_8BIT, 0x95, 0x03},//0x02},//916
	{GC2235_8BIT, 0x96, 0x94},//0xe0},
	{GC2235_8BIT, 0x97, 0x06},//0x05},//1616
	{GC2235_8BIT, 0x98, 0x50},//0x10},
	{GC2235_TOK_TERM, 0, 0},
};
...
struct gc2235f_settings gc2235f_sets[] = {
	[0] = {
		.init_settings = gc2235f_init_settings,
		.res_preview = gc2235f_res_preview,
		.res_still = gc2235f_res_still,
		.res_video = gc2235f_res_video,
		.n_res_preview = ARRAY_SIZE(gc2235f_res_preview),
		.n_res_still = ARRAY_SIZE(gc2235f_res_still),
		.n_res_video = ARRAY_SIZE(gc2235f_res_video),
	},
};
...
struct gc2235f_control {
	struct v4l2_queryctrl qc;
	int (*query)(struct v4l2_subdev *sd, s32 *value);
	int (*tweak)(struct v4l2_subdev *sd, s32 value);
};

/* gc2235f device structure */
struct gc2235f_device {
	...
	u8 type;
	u8 *otp_data;
	struct gc2235f_settings *mode_tables;
	const struct gc2235f_resolution *curr_res_table;
	int entries_curr_table;
};

#define to_gc2235f_sensor(x) container_of(x, struct gc2235f_device, sd)

#define GC2235_MAX_WRITE_BUF_SIZE	32
struct gc2235f_write_buffer {
	u16 addr;
	u8 data[GC2235_MAX_WRITE_BUF_SIZE];
};

struct gc2235f_write_ctrl {
	int index;
	struct gc2235f_write_buffer buffer;
};

static const struct gc2235f_reg gc2235f_param_update[] = {
	{GC2235_TOK_TERM, 0, 0}
};
#endif
