...
static struct misensor_reg ov2685_init_settings[] = {
	{MISENSOR_8BIT, 0x0103, 0x01},
	{MISENSOR_8BIT, 0x3002, 0x00},
	{MISENSOR_8BIT, 0x3016, 0x1c},
	{MISENSOR_8BIT, 0x3018, 0x84}, //0x84, 2Lane; 0x44, 1Lane
...
static struct misensor_reg ov2685_2M[] = {
	{MISENSOR_8BIT, 0x3503, 0x03},
	{MISENSOR_8BIT, 0x3501, 0x4e},
	{MISENSOR_8BIT, 0x3502, 0xe0},
	{MISENSOR_8BIT, 0x3620, 0x24},
	...
	{MISENSOR_8BIT, 0x3800, 0x00},
	{MISENSOR_8BIT, 0x3801, 0x00}, // X_START: 0;
	{MISENSOR_8BIT, 0x3802, 0x00},
	{MISENSOR_8BIT, 0x3803, 0x00}, // Y_START: 0;
	{MISENSOR_8BIT, 0x3804, 0x06},
	{MISENSOR_8BIT, 0x3805, 0x4f}, // X_END: 1615;
	{MISENSOR_8BIT, 0x3806, 0x04},
	{MISENSOR_8BIT, 0x3807, 0xbf}, // Y_END: 1215;
	{MISENSOR_8BIT, 0x3808, 0x06},
	{MISENSOR_8BIT, 0x3809, 0x40}, // X_SIZE: 1600;
	{MISENSOR_8BIT, 0x380a, 0x04},
	{MISENSOR_8BIT, 0x380b, 0xb0}, // Y_SIZE: 1200;
#if 0
	{MISENSOR_8BIT, 0x380c, 0x08},
	{MISENSOR_8BIT, 0x380d, 0xf2}, // HTS;
	{MISENSOR_8BIT, 0x380e, 0x07},
	{MISENSOR_8BIT, 0x380f, 0x84}, // VTS;
#else
	{MISENSOR_8BIT, 0x380c, 0x06},
	{MISENSOR_8BIT, 0x380d, 0xa4}, // HTS: 1700;
	{MISENSOR_8BIT, 0x380e, 0x05},
	{MISENSOR_8BIT, 0x380f, 0x0e}, // VTS: 1294;
#endif
	...
	{MISENSOR_8BIT, 0x4008, 0x02},
	{MISENSOR_8BIT, 0x4009, 0x09},
	// {MISENSOR_8BIT, 0x4837, 0x1e}, // 0x1e -> 0x50?
	{MISENSOR_8BIT, 0x5005, 0x12}, // bit[0]: binc enable;
	{MISENSOR_TOK_TERM, 0, 0}
};

static struct misensor_reg ov2685_1600x1064[] = {
	{MISENSOR_8BIT, 0x3503, 0x03},
	{MISENSOR_8BIT, 0x3501, 0x4e},
	{MISENSOR_8BIT, 0x3502, 0xe0},
	{MISENSOR_8BIT, 0x3620, 0x24},
	...
	{MISENSOR_8BIT, 0x3801, 0x00}, // X_START: 0;
	{MISENSOR_8BIT, 0x3802, 0x00},
	{MISENSOR_8BIT, 0x3803, 0x4b}, // Y_START: 75;
	{MISENSOR_8BIT, 0x3804, 0x06},
	{MISENSOR_8BIT, 0x3805, 0x4f}, // X_END: 1615;
	{MISENSOR_8BIT, 0x3806, 0x04},
	{MISENSOR_8BIT, 0x3807, 0xbf}, // Y_END: 1215;
	...
	{MISENSOR_8BIT, 0x3809, 0x40}, // X_SIZE: 1600;
	{MISENSOR_8BIT, 0x380a, 0x04},
	{MISENSOR_8BIT, 0x380b, 0x28}, // Y_SIZE: 1064;
	{MISENSOR_8BIT, 0x380c, 0x06},
	{MISENSOR_8BIT, 0x380d, 0xa4}, // HTS: 1700;
	{MISENSOR_8BIT, 0x380e, 0x05},
	{MISENSOR_8BIT, 0x380f, 0x0e}, // VTS: 1294;
...
static struct misensor_reg ov2685_1600x900[] = {
	{MISENSOR_8BIT, 0x3503, 0x03},
	{MISENSOR_8BIT, 0x3501, 0x4e},
	{MISENSOR_8BIT, 0x3502, 0xe0},
	{MISENSOR_8BIT, 0x3620, 0x24},
	...
	{MISENSOR_8BIT, 0x3801, 0x00}, // X_START: 0;
	{MISENSOR_8BIT, 0x3802, 0x00},
	{MISENSOR_8BIT, 0x3803, 0x9e}, // Y_START: 158;
	{MISENSOR_8BIT, 0x3804, 0x06},
	{MISENSOR_8BIT, 0x3805, 0x4f}, // X_END: 1615;
	{MISENSOR_8BIT, 0x3806, 0x04},
	{MISENSOR_8BIT, 0x3807, 0xbf}, // Y_END: 1215;
	{MISENSOR_8BIT, 0x3808, 0x06},
	{MISENSOR_8BIT, 0x3809, 0x40}, // X_SIZE: 1600;
	{MISENSOR_8BIT, 0x380a, 0x03},
	{MISENSOR_8BIT, 0x380b, 0x84}, // Y_SIZE: 900;
	{MISENSOR_8BIT, 0x380c, 0x06},
	{MISENSOR_8BIT, 0x380d, 0xa4}, // HTS: 1700;
	{MISENSOR_8BIT, 0x380e, 0x05},
	{MISENSOR_8BIT, 0x380f, 0x0e}, // VTS: 1294;
...
static struct misensor_reg ov2685_720p[] = {
	/*1lane 30fps*/
...
#if 0
static struct misensor_reg ov2685_704x576[] = {
	{MISENSOR_8BIT, 0x3620, 0x26},
	{MISENSOR_8BIT, 0x3621, 0x37},
	...
	{MISENSOR_8BIT, 0x3809, 0xc0}, // X_SIZE: 704;
	{MISENSOR_8BIT, 0x380a, 0x02},
	{MISENSOR_8BIT, 0x380b, 0x40}, // Y_SIZE: 576;
	{MISENSOR_8BIT, 0x380c, 0x08},
	{MISENSOR_8BIT, 0x380d, 0xf2},
	{MISENSOR_8BIT, 0x380e, 0x03},
	{MISENSOR_8BIT, 0x380f, 0x64},
	{MISENSOR_8BIT, 0x3811, 0x04},
	{MISENSOR_8BIT, 0x3813, 0x04},
	{MISENSOR_8BIT, 0x3814, 0x31},
	{MISENSOR_8BIT, 0x3815, 0x31},
	{MISENSOR_8BIT | MISENSOR_RMW_OR, 0x3820, 0xc2}, // vbin bit[1];
	{MISENSOR_8BIT | MISENSOR_RMW_OR, 0x3821, 0x01}, // hbin bit[0];
	{MISENSOR_8BIT, 0x382a, 0x08},
	{MISENSOR_8BIT, 0x3a00, 0x43},
	{MISENSOR_8BIT, 0x3a06, 0x00},
	{MISENSOR_8BIT, 0x3a07, 0x90},
	{MISENSOR_8BIT, 0x3a08, 0x00},
	{MISENSOR_8BIT, 0x3a09, 0x78},
	{MISENSOR_8BIT, 0x3a0e, 0x05},//4 },
	{MISENSOR_8BIT, 0x3a0f, 0xa0},//80},
	{MISENSOR_8BIT, 0x3a10, 0x05},//4 },
	{MISENSOR_8BIT, 0x3a11, 0xa0},//38},
	{MISENSOR_8BIT, 0x3a0a, 0x05},//4 },
	{MISENSOR_8BIT, 0x3a0b, 0xa0},//80},
	{MISENSOR_8BIT, 0x3a0c, 0x05},//4 },
	{MISENSOR_8BIT, 0x3a0d, 0xa0},//38},
	// {MISENSOR_8BIT, 0x3a13, 0xf8},
	{MISENSOR_8BIT, 0x4008, 0x00},
	{MISENSOR_8BIT, 0x4009, 0x03},
	// {MISENSOR_8BIT, 0x4837, 0x50}, // 0x1e -> 0x50?
	{MISENSOR_8BIT, 0x5003, 0x04},
	{MISENSOR_8BIT, 0x3503, 0x00},
	// {MISENSOR_8BIT, 0x0100, 0x01},
	{MISENSOR_TOK_TERM, 0, 0}
...
static struct misensor_reg ov2685_800x600[] = {
...
static struct ov_res_struct ov2685_res[] = {
#if 0
	{
		.desc	= "D1",
		.res_id	= RES_SVGA,
		.width	= RES_D1_SIZE_H,
		.height	= RES_D1_SIZE_V,
		.fps	= 30,
		.used	= 0,
		.skip_frames = 1,
		.regs = ov2685_704x576,
		.aspt_ratio = RATIO_CIF,
		.csi_lanes = 2,
	...
	},
	{
		...
		.used	= 0,
		.skip_frames = 2,
		.regs = ov2685_1600x1064,
		.aspt_ratio = RATIO_3_2,
		.csi_lanes = 2,
		.max_exposure_lines = 1290,
	},
	{
...
static struct ov_reglist_map ov2685_exposure_table[] = {
	{ -2, ov2685_exp_0 },
	{ -1, ov2685_exp_1 },
	{ 0, ov2685_exp_2 },
	{ 1, ov2685_exp_3 },
...
static struct misensor_reg  ov2685_stream_off[] = {
	{MISENSOR_8BIT, 0x4202, 0x0f},
	{MISENSOR_8BIT, 0x301c, 0xf4},
	{MISENSOR_TOK_TERM, 0, 0}
};

static struct misensor_reg  ov2685_stream_on[] = {
	{MISENSOR_8BIT, 0x4202, 0x00},
	{MISENSOR_8BIT, 0x301c, 0xf0},
	{MISENSOR_TOK_TERM, 0, 0}
};

static struct ov_reglist_map ov2685_stream_table[] = {
	{ 0x0, ov2685_stream_off },
	{ 0x1, ov2685_stream_on  },
};
...
static struct ov_reglist_map ov2685_vflip_table[] = {
	{ 0x0, ov2685_vflip_0 },
	{ 0x1, ov2685_vflip_1 },
};

static struct ov_reglist_map ov2685_hflip_table[] = {
	{ 0x0, ov2685_hflip_0 },
	{ 0x1, ov2685_hflip_1 },
};
...
static struct ov_reglist_map ov2685_scenemode_table[] = {
	{ V4L2_SCENE_MODE_NONE, ov2685_scene_0 },
	{ V4L2_SCENE_MODE_BACKLIGHT, ov2685_scene_1 },
	{ V4L2_SCENE_MODE_BEACH_SNOW, ov2685_scene_2 },
	{ V4L2_SCENE_MODE_CANDLE_LIGHT, ov2685_scene_3 },
	{ V4L2_SCENE_MODE_DAWN_DUSK, ov2685_scene_4 },
	{ V4L2_SCENE_MODE_FALL_COLORS, ov2685_scene_5 },
	{ V4L2_SCENE_MODE_FIREWORKS, ov2685_scene_6 },
	{ V4L2_SCENE_MODE_LANDSCAPE, ov2685_scene_7 },
	{ V4L2_SCENE_MODE_NIGHT, ov2685_scene_8 },
	{ V4L2_SCENE_MODE_PARTY_INDOOR, ov2685_scene_9 },
	{ V4L2_SCENE_MODE_PORTRAIT, ov2685_scene_10 },
	{ V4L2_SCENE_MODE_SPORTS, ov2685_scene_11 },
...
static struct ov_reglist_map ov2685_awb_table[] = {
	{ V4L2_WHITE_BALANCE_MANUAL, ov2685_awb_0 },
	{ V4L2_WHITE_BALANCE_AUTO, ov2685_awb_1  },
	{ V4L2_WHITE_BALANCE_INCANDESCENT, ov2685_awb_2  },
	{ V4L2_WHITE_BALANCE_FLUORESCENT, ov2685_awb_3  },
	{ V4L2_WHITE_BALANCE_FLUORESCENT_H, ov2685_awb_4  },
	{ V4L2_WHITE_BALANCE_HORIZON, ov2685_awb_5  },
...
static struct misensor_reg  ov2685_uyvy16[] = {
	{MISENSOR_TOK_TERM, 0, 0}
};

static struct misensor_reg  ov2685_yuyv16[] = {
	{MISENSOR_TOK_TERM, 0, 0}
};

static struct ov_mbus_fmt ov2685_fmts[] = {
	{
		.desc		= "YUYV 4:2:2",
		.code		= V4L2_MBUS_FMT_UYVY8_1X16,
		.reg_list	= ov2685_uyvy16,
		.size		= ARRAY_SIZE(ov2685_uyvy16),
		.bpp		= 2,
	}, {
		.desc		= "YUYV 4:2:2",
		.code		= V4L2_MBUS_FMT_YUYV8_1X16,
		.reg_list	= ov2685_yuyv16,
		.size		= ARRAY_SIZE(ov2685_yuyv16),
		.bpp		= 2,
	},
};
...
static struct ov_res_struct ov2685_init = {
	.desc	= "2M",
	.res_id	= RES_2M,
	.width	= RES_2M_SIZE_H,
	.height = RES_2M_SIZE_V,
	...
	.used	= 0,
	.skip_frames = 0,
	.regs = ov2685_init_settings,
	.csi_lanes = 2,
};

struct ov_product_info ov2685_product_info = {
	...
	.ov_init = &ov2685_init,
	.settings_tbl = {
		ADD_SETTINGS_TABLES(OV_SETTING_STREAM, ov2685_stream_table),
		ADD_SETTINGS_TABLES(OV_SETTING_EXPOSURE, ov2685_exposure_table),
		ADD_SETTINGS_TABLES(OV_SETTING_VFLIP, ov2685_vflip_table),
	...
	.ov_res = ov2685_res,
	.ov_fmt = ov2685_fmts,
	.num_res = ARRAY_SIZE(ov2685_res),
	.num_fmt = ARRAY_SIZE(ov2685_fmts),
};
