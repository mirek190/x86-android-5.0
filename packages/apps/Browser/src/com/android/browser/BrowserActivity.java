...
public class BrowserActivity extends Activity {
    ...
    protected void onResume() {
        ...
        //For some special inputmethod like googlepin which need to use adjust_pan not adjust_resize.
        final InputMethodManager imm = (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);
        Log.v(LOGTAG, "onPreferenceTreeClick : getCurrentInputMethodSubtype : " + imm.getCurrentInputMethodSubtype());
        if(imm.getCurrentInputMethodSubtype() != null) {
            Log.v(LOGTAG, "onPreferenceTreeClick : getCurrentInputMethodSubtype.getLocale() : " + imm.getCurrentInputMethodSubtype().getLocale());
            Log.v(LOGTAG, "onPreferenceTreeClick : getCurrentInputMethodSubtype.getNameResId(): " + imm.getCurrentInputMethodSubtype().getNameResId());
            Log.v(LOGTAG, "onPreferenceTreeClick : getCurrentInputMethodSubtype.getMode() : " + imm.getCurrentInputMethodSubtype().getMode());
            if(imm.getCurrentInputMethodSubtype().getLocale().equals("en_US")) {
