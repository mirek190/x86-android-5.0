...
#ifndef OMX_VIDEO_DECODER_MPEG4_H_
#define OMX_VIDEO_DECODER_MPEG4_H_


#include "OMXVideoDecoderBase.h"

class OMXVideoDecoderMPEG4 : public OMXVideoDecoderBase {
public:
    OMXVideoDecoderMPEG4();
    virtual ~OMXVideoDecoderMPEG4();
...
#endif /* OMX_VIDEO_DECODER_MPEG4_H_ */
