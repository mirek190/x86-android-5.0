...
protected:
    ...
    bool mForceKFrame;
    bool mRenderTemporalLayerRC;
    uint32_t mForceKFrameNumber;
    ...
    android::List<VideoEncoderStatistics *> mStatisticsQueue;
    VideoEncoderStatistics mStatistics;
