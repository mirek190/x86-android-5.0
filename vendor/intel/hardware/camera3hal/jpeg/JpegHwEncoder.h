...
#ifndef _CAMERA3_HAL_JPEG_HWENCODER_H_
#define _CAMERA3_HAL_JPEG_HWENCODER_H_
...
public:
    ...
    status_t setInputBuffers(InputBuffer* inputBuffersArray, int inputBuffersNum);
...
public:
    ...
    int setInputBuffers(InputBuffer* inputBuffersArray, int inputBuffersNum) {
        UNUSED(inputBuffersArray);
        UNUSED(inputBuffersNum);
        return -1;
    }
    int encode(const InputBuffer &in, OutputBuffer &out) {
        UNUSED(in);
...
#endif // _CAMERA3_HAL_JPEG_HWENCODER_H_
