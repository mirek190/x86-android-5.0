...
const metadata_value_t android_request_availableCapabilities_values[] = {
                 ...
                 {"ZSL", ANDROID_REQUEST_AVAILABLE_CAPABILITIES_ZSL },
         };
...
const metadata_tag_t android_static_tags_table[] = {
    ...
    {"control.aeAvailableTargetFpsRanges", ANDROID_CONTROL_AE_AVAILABLE_TARGET_FPS_RANGES, TYPE_INT32, NULL, 0, true, {2,-1,0}, RANGE_INT },
    {"control.aeCompensationRange", ANDROID_CONTROL_AE_COMPENSATION_RANGE, TYPE_INT32, NULL, 0, true, {2,0,0}, RANGE_INT },
    {"control.aeCompensationStep", ANDROID_CONTROL_AE_COMPENSATION_STEP, TYPE_RATIONAL, NULL, 0, false, {0,0,0}, 0 },
    ...
    {"control.availableSceneModes", ANDROID_CONTROL_AVAILABLE_SCENE_MODES, TYPE_BYTE, android_control_sceneMode_values, 19, true, {-1,0,0}, ENUM_LIST },
    ...
    {"control.maxRegions", ANDROID_CONTROL_MAX_REGIONS, TYPE_INT32, NULL, 0, true, {3,0,0}, 0 },
    {"control.sceneModeOverrides", ANDROID_CONTROL_SCENE_MODE_OVERRIDES, TYPE_BYTE, NULL, 0, true, {3,-1,0}, 0 },
    {"control.availableHighSpeedVideoConfigurations", ANDROID_CONTROL_AVAILABLE_HIGH_SPEED_VIDEO_CONFIGURATIONS, TYPE_INT32, NULL, 0, true, {4,-1,0}, HIGH_SPEED_VIDEO_CONFIGURATION },
    // DEMOSAIC
    // EDGE
    {"edge.availableEdgeModes", ANDROID_EDGE_AVAILABLE_EDGE_MODES, TYPE_BYTE, android_edge_mode_values, 3, true, {-1,0,0}, ENUM_LIST },
    // FLASH
    {"flash.colorTemperature", ANDROID_FLASH_COLOR_TEMPERATURE, TYPE_BYTE, NULL, 0, false, {0,0,0}, 0 },
    {"flash.maxEnergy", ANDROID_FLASH_MAX_ENERGY, TYPE_BYTE, NULL, 0, false, {0,0,0}, 0 },
    {"flash.info.available", ANDROID_FLASH_INFO_AVAILABLE, TYPE_BYTE, android_flash_info_available_values, 2, false, {0,0,0}, 0 },
    {"flash.info.chargeDuration", ANDROID_FLASH_INFO_CHARGE_DURATION, TYPE_INT64, NULL, 0, false, {0,0,0}, 0 },
    // HOT_PIXEL
    ...
    // JPEG
    {"jpeg.availableThumbnailSizes", ANDROID_JPEG_AVAILABLE_THUMBNAIL_SIZES, TYPE_INT32, NULL, 0, true, {2,-1,0}, SIZE },
    {"jpeg.maxSize", ANDROID_JPEG_MAX_SIZE, TYPE_INT32, NULL, 0, false, {0,0,0}, 0 },
    // LENS
    {"lens.facing", ANDROID_LENS_FACING, TYPE_BYTE, android_lens_facing_values, 2, false, {0,0,0}, 0 },
    {"lens.opticalAxisAngle", ANDROID_LENS_OPTICAL_AXIS_ANGLE, TYPE_FLOAT, NULL, 0, true, {2,0,0}, 0 },
    {"lens.position", ANDROID_LENS_POSITION, TYPE_FLOAT, NULL, 0, true, {-1,0,0}, 0 },
    {"lens.info.availableApertures", ANDROID_LENS_INFO_AVAILABLE_APERTURES, TYPE_FLOAT, NULL, 0, true, {-1,0,0}, 0 },
    {"lens.info.availableFilterDensities", ANDROID_LENS_INFO_AVAILABLE_FILTER_DENSITIES, TYPE_FLOAT, NULL, 0, true, {-1,0,0}, 0 },
    {"lens.info.availableFocalLengths", ANDROID_LENS_INFO_AVAILABLE_FOCAL_LENGTHS, TYPE_FLOAT, NULL, 0, true, {-1,0,0}, 0 },
    ...
    {"lens.info.hyperfocalDistance", ANDROID_LENS_INFO_HYPERFOCAL_DISTANCE, TYPE_FLOAT, NULL, 0, false, {0,0,0}, 0 },
    {"lens.info.minimumFocusDistance", ANDROID_LENS_INFO_MINIMUM_FOCUS_DISTANCE, TYPE_FLOAT, NULL, 0, false, {0,0,0}, 0 },
    {"lens.info.shadingMapSize", ANDROID_LENS_INFO_SHADING_MAP_SIZE, TYPE_INT32, NULL, 0, true, {2,0,0}, SIZE },
    ...
    // NOISE_REDUCTION
    {"noiseReduction.availableNoiseReductionModes", ANDROID_NOISE_REDUCTION_AVAILABLE_NOISE_REDUCTION_MODES, TYPE_BYTE, android_noiseReduction_mode_values, 3, true, {-1,0,0}, ENUM_LIST },
    // QUIRKS
    {"quirks.meteringCropRegion", ANDROID_QUIRKS_METERING_CROP_REGION, TYPE_BYTE, NULL, 0, false, {0,0,0}, 0 },
    {"quirks.triggerAfWithAuto", ANDROID_QUIRKS_TRIGGER_AF_WITH_AUTO, TYPE_BYTE, NULL, 0, false, {0,0,0}, 0 },
    {"quirks.useZslFormat", ANDROID_QUIRKS_USE_ZSL_FORMAT, TYPE_BYTE, NULL, 0, false, {0,0,0}, 0 },
    {"quirks.usePartialResult", ANDROID_QUIRKS_USE_PARTIAL_RESULT, TYPE_BYTE, NULL, 0, false, {0,0,0}, 0 },
    // REQUEST
    {"request.maxNumOutputStreams", ANDROID_REQUEST_MAX_NUM_OUTPUT_STREAMS, TYPE_INT32, NULL, 0, true, {3,0,0}, 0 },
    {"request.maxNumReprocessStreams", ANDROID_REQUEST_MAX_NUM_REPROCESS_STREAMS, TYPE_INT32, NULL, 0, true, {1,0,0}, 0 },
    {"request.maxNumInputStreams", ANDROID_REQUEST_MAX_NUM_INPUT_STREAMS, TYPE_INT32, NULL, 0, false, {0,0,0}, 0 },
    {"request.pipelineMaxDepth", ANDROID_REQUEST_PIPELINE_MAX_DEPTH, TYPE_BYTE, NULL, 0, false, {0,0,0}, 0 },
    {"request.partialResultCount", ANDROID_REQUEST_PARTIAL_RESULT_COUNT, TYPE_INT32, NULL, 0, false, {0,0,0}, 0 },
    {"request.availableCapabilities", ANDROID_REQUEST_AVAILABLE_CAPABILITIES, TYPE_BYTE, android_request_availableCapabilities_values, 5, true, {-1,0,0}, 0 },
    {"request.availableRequestKeys", ANDROID_REQUEST_AVAILABLE_REQUEST_KEYS, TYPE_INT32, NULL, 0, true, {-1,0,0}, 0 },
    {"request.availableResultKeys", ANDROID_REQUEST_AVAILABLE_RESULT_KEYS, TYPE_INT32, NULL, 0, true, {-1,0,0}, 0 },
    {"request.availableCharacteristicsKeys", ANDROID_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS, TYPE_INT32, NULL, 0, true, {-1,0,0}, 0 },
    // SCALER
    ...
    {"scaler.availableJpegMinDurations", ANDROID_SCALER_AVAILABLE_JPEG_MIN_DURATIONS, TYPE_INT64, NULL, 0, true, {-1,0,0}, 0 },
    {"scaler.availableJpegSizes", ANDROID_SCALER_AVAILABLE_JPEG_SIZES, TYPE_INT32, NULL, 0, true, {-1,2,0}, SIZE },
    {"scaler.availableMaxDigitalZoom", ANDROID_SCALER_AVAILABLE_MAX_DIGITAL_ZOOM, TYPE_FLOAT, NULL, 0, false, {0,0,0}, 0 },
    {"scaler.availableProcessedMinDurations", ANDROID_SCALER_AVAILABLE_PROCESSED_MIN_DURATIONS, TYPE_INT64, NULL, 0, true, {-1,0,0}, 0 },
    {"scaler.availableProcessedSizes", ANDROID_SCALER_AVAILABLE_PROCESSED_SIZES, TYPE_INT32, NULL, 0, true, {-1,2,0}, SIZE },
    {"scaler.availableRawMinDurations", ANDROID_SCALER_AVAILABLE_RAW_MIN_DURATIONS, TYPE_INT64, NULL, 0, true, {-1,0,0}, 0 },
    {"scaler.availableRawSizes", ANDROID_SCALER_AVAILABLE_RAW_SIZES, TYPE_INT32, NULL, 0, true, {-1,2,0}, SIZE },
    {"scaler.availableInputOutputFormatsMap", ANDROID_SCALER_AVAILABLE_INPUT_OUTPUT_FORMATS_MAP, TYPE_INT32, NULL, 0, true, {-1,0,0}, IMAGE_FORMAT },
    ...
    {"scaler.availableMinFrameDurations", ANDROID_SCALER_AVAILABLE_MIN_FRAME_DURATIONS, TYPE_INT64, NULL, 0, true, {4,-1,0}, STREAM_CONFIGURATION_DURATION },
    {"scaler.availableStallDurations", ANDROID_SCALER_AVAILABLE_STALL_DURATIONS, TYPE_INT64, NULL, 0, true, {4,-1,0}, STREAM_CONFIGURATION_DURATION },
    ...
    {"sensor.referenceIlluminant2", ANDROID_SENSOR_REFERENCE_ILLUMINANT2, TYPE_BYTE, NULL, 0, false, {0,0,0}, 0 },
    {"sensor.calibrationTransform1", ANDROID_SENSOR_CALIBRATION_TRANSFORM1, TYPE_RATIONAL, NULL, 0, true, {3,3,0}, COLOR_SPACE_TRANSFORM },
    {"sensor.calibrationTransform2", ANDROID_SENSOR_CALIBRATION_TRANSFORM2, TYPE_RATIONAL, NULL, 0, true, {3,3,0}, COLOR_SPACE_TRANSFORM },
    {"sensor.colorTransform1", ANDROID_SENSOR_COLOR_TRANSFORM1, TYPE_RATIONAL, NULL, 0, true, {3,3,0}, COLOR_SPACE_TRANSFORM },
    {"sensor.colorTransform2", ANDROID_SENSOR_COLOR_TRANSFORM2, TYPE_RATIONAL, NULL, 0, true, {3,3,0}, COLOR_SPACE_TRANSFORM },
    {"sensor.forwardMatrix1", ANDROID_SENSOR_FORWARD_MATRIX1, TYPE_RATIONAL, NULL, 0, true, {3,3,0}, COLOR_SPACE_TRANSFORM },
    {"sensor.forwardMatrix2", ANDROID_SENSOR_FORWARD_MATRIX2, TYPE_RATIONAL, NULL, 0, true, {3,3,0}, COLOR_SPACE_TRANSFORM },
    {"sensor.baseGainFactor", ANDROID_SENSOR_BASE_GAIN_FACTOR, TYPE_RATIONAL, NULL, 0, false, {0,0,0}, 0 },
    {"sensor.blackLevelPattern", ANDROID_SENSOR_BLACK_LEVEL_PATTERN, TYPE_INT32, NULL, 0, true, {4,0,0}, BLACK_LEVEL_PATTERN },
    {"sensor.maxAnalogSensitivity", ANDROID_SENSOR_MAX_ANALOG_SENSITIVITY, TYPE_INT32, NULL, 0, false, {0,0,0}, 0 },
    {"sensor.orientation", ANDROID_SENSOR_ORIENTATION, TYPE_INT32, NULL, 0, false, {0,0,0}, 0 },
    {"sensor.profileHueSatMapDimensions", ANDROID_SENSOR_PROFILE_HUE_SAT_MAP_DIMENSIONS, TYPE_INT32, NULL, 0, true, {3,0,0}, 0 },
    ...
    {"sensor.info.activeArraySize", ANDROID_SENSOR_INFO_ACTIVE_ARRAY_SIZE, TYPE_INT32, NULL, 0, true, {4,0,0}, RECTANGLE },
    {"sensor.info.sensitivityRange", ANDROID_SENSOR_INFO_SENSITIVITY_RANGE, TYPE_INT32, NULL, 0, true, {2,0,0}, RANGE_INT },
    ...
    {"sensor.info.exposureTimeRange", ANDROID_SENSOR_INFO_EXPOSURE_TIME_RANGE, TYPE_INT64, NULL, 0, true, {2,0,0}, RANGE_LONG },
    {"sensor.info.maxFrameDuration", ANDROID_SENSOR_INFO_MAX_FRAME_DURATION, TYPE_INT64, NULL, 0, false, {0,0,0}, 0 },
    {"sensor.info.physicalSize", ANDROID_SENSOR_INFO_PHYSICAL_SIZE, TYPE_FLOAT, NULL, 0, true, {2,0,0}, SIZE_F },
    {"sensor.info.pixelArraySize", ANDROID_SENSOR_INFO_PIXEL_ARRAY_SIZE, TYPE_INT32, NULL, 0, true, {2,0,0}, SIZE },
    {"sensor.info.whiteLevel", ANDROID_SENSOR_INFO_WHITE_LEVEL, TYPE_INT32, NULL, 0, false, {0,0,0}, 0 },
    ...
    {"statistics.info.histogramBucketCount", ANDROID_STATISTICS_INFO_HISTOGRAM_BUCKET_COUNT, TYPE_INT32, NULL, 0, false, {0,0,0}, 0 },
    {"statistics.info.maxFaceCount", ANDROID_STATISTICS_INFO_MAX_FACE_COUNT, TYPE_INT32, NULL, 0, false, {0,0,0}, 0 },
    {"statistics.info.maxHistogramCount", ANDROID_STATISTICS_INFO_MAX_HISTOGRAM_COUNT, TYPE_INT32, NULL, 0, false, {0,0,0}, 0 },
    {"statistics.info.maxSharpnessMapValue", ANDROID_STATISTICS_INFO_MAX_SHARPNESS_MAP_VALUE, TYPE_INT32, NULL, 0, false, {0,0,0}, 0 },
    {"statistics.info.sharpnessMapSize", ANDROID_STATISTICS_INFO_SHARPNESS_MAP_SIZE, TYPE_INT32, NULL, 0, true, {2,0,0}, SIZE },
    ...
    // TONEMAP
    {"tonemap.maxCurvePoints", ANDROID_TONEMAP_MAX_CURVE_POINTS, TYPE_INT32, NULL, 0, false, {0,0,0}, 0 },
    {"tonemap.availableToneMapModes", ANDROID_TONEMAP_AVAILABLE_TONE_MAP_MODES, TYPE_BYTE, android_tonemap_mode_values, 3, true, {-1,0,0}, ENUM_LIST },
    // LED
...
#define STATIC_TAGS_TABLE_SIZE 95
