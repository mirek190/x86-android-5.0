...
public class ThermalManager {
    ...
    public static final String BIOS_CONFIG_DIR_PATH = "/data/acpi_thermal/";
    ...
    /* Set the default room temp value in millidegree Celcius for moving average */
    public static final int DEFAULT_ROOM_TEMP = 25000;
    ...
    /* Name of the BatterySaver Thermal Profile */
    public static final String BATTERY_SAVER_PROFILE_NAME = "BatterySaver";

    /* Lock protecting profile-switch */
    private static final Object sProfileSwitchLock = new Object();

    static boolean isLowPowerMode = false;

    static String sLastProfile = DEFAULT_PROFILE_NAME;
    /**
    ...
    public static void startBatterySaverProfile() {
        if (isProfileExists(BATTERY_SAVER_PROFILE_NAME)) {
            startNewProfile(BATTERY_SAVER_PROFILE_NAME);
        }
        // register for Thermal Profile Change Intent only after
        // we have started the profile
        sCoolingManager.registerProfChangeListener();
    }
