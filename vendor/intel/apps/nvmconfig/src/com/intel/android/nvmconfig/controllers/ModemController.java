...
public interface ModemController<C extends ModemControlCommand, R extends ModemControlResponse> extends Closeable {

    public R writeRawCommand(C command) throws ModemControlException;
}
