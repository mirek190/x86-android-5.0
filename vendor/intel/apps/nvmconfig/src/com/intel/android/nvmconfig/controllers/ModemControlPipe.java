...
public interface ModemControlPipe<C extends ModemControlCommand, R extends ModemControlResponse> extends Closeable {

    public R writeToModemControl(C command) throws ModemControlException;
    public void close();
}
